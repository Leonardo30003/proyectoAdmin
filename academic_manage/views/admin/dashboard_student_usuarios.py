...
# Estado para manejar la navegación y el registro de usuarios
class UserRegisterState(rx.State):
    name: str = ""
    last_name: str = ""
    email: str = ""
    cedula: str = ""
    ...
    def handle_register(self):
        ...
        if result:
            ...
            return rx.redirect("/dashboard_student_usuarios")
        else:
        ...
        rx.card(
            rx.vstack(
                ...
                rx.vstack(
                    ...
                    rx.input(
                        placeholder="Nombre",
                        on_change=lambda value: UserRegisterState.handle_change("name", value),
                        style={
                            "width": "100%",
                            "border_color": "#001737",
                    ...
                    rx.input(
                        ...
                        padding="0.50em",
                        on_change=lambda value: UserRegisterState.handle_change("last_name", value),
                    ),
                    rx.text(
                        "Correo Electrónico",
                        size="1.5em",
                    ...
                    rx.input(
                        ...
                        border_radius="0.75em",
                        padding="0.50em",
                        on_change=lambda value: UserRegisterState.handle_change("email", value),
                    ),
                    rx.text(
                        "Cédula",
                        size="1.5em",
                    ...
                    rx.input(
                        ...
                        border_radius="0.75em",
                        padding="0.50em",
                        on_change=lambda value: UserRegisterState.handle_change("cedula", value),
                    ),
                    rx.text(
                        "Rol",
                        size="1.5em",
                    ...
                    rx.select(
                        ...
                        color_scheme="blue",
                        size="3",
                        on_change=lambda value: UserRegisterState.handle_change("rol", value),
                    ),
                    rx.box(
                        rx.checkbox(
                            rx.text("Activo", color="black"),
                            default_checked=UserRegisterState.active,
                            on_change=lambda value: UserRegisterState.handle_checkbox(value),
                            color_scheme="indigo",
                        ),
                    ),
                    rx.button(
